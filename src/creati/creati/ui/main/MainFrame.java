...
/**
 * MainFrame (조립 + 카드 전환 + 상단/사이드)
 * - HOME 화면은 MainHomeView로 분리
 * - 커스텀 컴포넌트/이미지 유틸은 MainUiParts로 분리
 * - CHALLENGE는 ChallengeView (검색 연동)
 */
public class MainFrame extends JFrame {
    ...
    private JComponent buildTopBar() {
        ...
        JButton settingsBtn = new EllipsisButton();
        ...
        btn.addMouseListener(new java.awt.event.MouseAdapter() {
            @Override public void mouseEntered(java.awt.event.MouseEvent e) {
                ...
                btn.setBorder(BorderFactory.createCompoundBorder(
                        BorderFactory.createLineBorder(LAVENDER_BORDER, 1, true),
